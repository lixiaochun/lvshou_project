<template>
  <div class=" videoPlayer2">
    <div class="player video-box">
      <video-player ref="myPlayer" controls preload="auto"  data-setup="{}"  controls  class="video-player vjs-custom-skin"
      x5-playsinline="true"    :x5-playsinline="true" playsinline="true" :webkit-playsinline="true" webkit-playsinline="true"
                     :playsinline="true"
        ...
        <div class="playBtn_box" v-if="imgType">
          <img @click="fPlayBtn" src="../../../src/assets/video/play.png" class="playBtn"  >
        </div>
...
//        playbackRates: [0.7, 1.0, 1.5, 2.0], //播放速度
  ...
  mounted() { 
    //this.playerOptions.poster="http://hxsupload.oss-cn-hangzhou.aliyuncs.com/2019-03-25/ce4a2773c1987bf5260cffd76d7a5037.jpg";
    //this.playerOptions.sources[0].src="http://hxsapp.oss-cn-hangzhou.aliyuncs.com/mallVideo/20170624 真人变型记（剪辑） MP4 S.mp4";
    alert("开始")
    this.imgType=false;
    ...
    //     that.playerOptions.preload="auto"
    //   }
    // }
  },
  methods: {
...
.videoPlayer2  .vjs-vol-1,.videoPlayer2  .vjs-vol-2,.videoPlayer2  .vjs-vol-3{
  background-image: url("../../../src/assets/video/colume2.png");
background-position:50% 50%;background-size:cover;background-repeat:no-repeat;
background-size: 60%;
}
.videoPlayer2  .vjs-vol-0{
  background-image: url("../../../src/assets/video/colume1.png");
 background-position:50% 50%;background-size:cover;background-repeat:no-repeat;
 background-size: 60%;
