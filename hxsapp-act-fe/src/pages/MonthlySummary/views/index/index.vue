...
export default {
  data() {
    const imgSty = 'width:100%;vertical-align:bottom;';
    ...
    return {
      ...
      actInfo: {},
      imgLists: [
        { src: require('../../assets/images/img_01.jpg'), imgSty },
        { src: require('../../assets/images/img_02.jpg'), imgSty },
        { src: require('../../assets/images/img_03.jpg'), imgSty },
        { src: require('../../assets/images/img_04.jpg'), imgSty },
        { src: require('../../assets/images/img_05.jpg'), imgSty },
        { src: require('../../assets/images/img_06.jpg'), imgSty },
        { src: require('../../assets/images/img_7.png'), imgSty: imgInvolved, imgBox: imgSty },
        { src: require('../../assets/images/img_8.png'), imgSty: imgTell, imgBox: imgSty }
      ]
    }
  },
  created() {
