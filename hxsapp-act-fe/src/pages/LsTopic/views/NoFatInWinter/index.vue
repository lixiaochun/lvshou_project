...
export default {
  data() {
    ...
    return {
      ...
      topicId: null,
      imgLists: [
        { src: require('../../assets/images/NoFatInWinter/img_01.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_02.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_03.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_04.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_05.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_06.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_07.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_08.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_09.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_10.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_11.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_12.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_13.jpg'), imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_14.jpg'), imgSty: imgInvolved, imgBox: imgSty },
        { src: require('../../assets/images/NoFatInWinter/img_15.png'), imgSty: imgTell, imgBox: imgSty }
      ]
    }
  },
  created() {
    ...
    _hmt.push(['_trackEvent', '按钮', '冬天不养膘', '页面初始化'])
  },
  methods: {
    async getBaseInfo() {
      // 通过接口获取基础信息
    ...
    imagesClick(key) {
      ...
      if (key === imgLists.length - 1) {
        _hmt.push(['_trackEvent', '按钮', '冬天不养膘', '减肥咨询'])
        this.suspension()
      }
      if (key === imgLists.length - 2) {
        _hmt.push(['_trackEvent', '按钮', '冬天不养膘', '马上参与'])
