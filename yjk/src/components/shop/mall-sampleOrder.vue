        ...
        <list-table>
            ...
            <div>
              <ul class="screening">
                ...
                <li>
                  <span>订单编号：</span>
                  <div>
                    <el-input placeholder="订单编号" clearable v-model.trim="orderNo" size="mini" style="width: 100%;">
                ...
                <li>
                  <span>会员昵称：</span>
                  <div>
                  <el-input placeholder="会员昵称" clearable v-model.trim="userName" size="mini" style="width: 100%; margin-right: 10px;">
                    <i slot="prefix" class="el-input__icon el-icon-search"></i>
                  </el-input>
                  </div>
                </li>
          ...
          <div class="custom-table">
            <el-table style="width: 100%;"
              ...
              <el-table-column label="消费金额（元)" width="180" align="center">
                <template slot-scope="scope">
                  <div class="mt-40">
...
import { getStandardOrderList } from 'api/mall'
...
export default {
  ...
  methods: {
    ...
    editAction(idx, table) {
      ...
      this.$router.push({ path: '/shop/sampleDetails', query: { id }})
    },
    _getOrderList(reset) {
      this.loding = true
      ...
      getStandardOrderList({ state, orderNo, userName, startDate, endDate, pageNum, pageSize }).then(res => {
