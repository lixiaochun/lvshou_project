<template>
  <div class="punchTheClock">
    ...
    <div style="position: relative">
      <ls-image v-for="(item, key) in imgLists" :key="key" :src="item.src" :imgSty="item.imgSty" :index="key" :click="item.click"></ls-image>
    ...
    <div class="footerToH5">
      <div class="toh5" @click="hxsapp_jump_dynamic">
        <img :src="footerImage" style="vertical-align: bottom;width: 100%;"/>
      </div>
    </div>
  </div>
</template>
...
import { urlGet, isApp, getHxsAppVersion, compareAppVersion, LsShare, splicingUrl, userAgent } from 'Utils/common'
...
export default {
  data() {
    ...
    return {
      ...
      topicId: null,
      footerImage: require('../../assets/images/smartRunningShoes/img_11.jpg'),
      suspensionImg: {
      ...
      imgLists: [
        { src: require('../../assets/images/smartRunningShoes/img_01.jpg'), imgSty },
        { src: require('../../assets/images/smartRunningShoes/img_02.jpg'), imgSty },
        { src: require('../../assets/images/smartRunningShoes/img_03.jpg'), imgSty },
        { src: require('../../assets/images/smartRunningShoes/img_04.jpg'), imgSty },
        { src: require('../../assets/images/smartRunningShoes/img_05.jpg'), imgSty },
        { src: require('../../assets/images/smartRunningShoes/img_06.jpg'), imgSty },
        { src: require('../../assets/images/smartRunningShoes/img_07.jpg'), imgSty }
      ]
    }
  },
  created() {
    ...
    this.$on('imageClick', function () {
      console.log('-------------click----------');
    })
  },
  mounted () {
    _hmt.push(['_trackEvent', '按钮', '智能跑鞋，助力享瘦', '页面初始化'])
  },
  methods: {
    async getBaseInfo() {
      // 通过接口获取基础信息
    ...
    verification() {
      ...
      if (!isApp() || this.is_web) {
        /* 下载APP */
        _hmt.push(['_trackEvent', '按钮', '智能跑鞋，助力享瘦', '下载APP'])
        window.location.href = 'http://app.hxsapp.com/html/channel_statistics.html?channel_id=581'
        return false;
      }
    ...
    suspension() {
      _hmt.push(['_trackEvent', '按钮', '智能跑鞋，助力享瘦', '智能跑鞋，助力享瘦'])
      var _this = this;
      /* 判断是否APP操作 */
    ...
    async hxsapp_jump_dynamic() {
      await _hmt.push(['_trackEvent', '按钮', '智能跑鞋，助力享瘦', '马上参与'])
      /* 判断是否APP操作 || 没有话题ID */
      if (!this.verification()) {
        return false;
      }
      ...
      // 我的邀请
      if (userAgent() === 'and') {
          window.location.href = 'https://hxsapp_gopage?page_name=com.lvshou.hxs.activity.InvitationActivity'
      } else {
          window.location.href = 'https://hxsapp_gopage?page_name=MyInvitedsViewController'
      }
      /* https://hxsapp_jump_dynamic#话题id */
      // window.location.href = 'https://hxsapp_jump_dynamic#' + this.topicId;
    },
    imagesClick (index) {
      // mintToast('复制成功，赶紧添加 hxs12307 为微信好友^_^');
      // clipboard.writeText('hxs12307');
    }
  }
}
</script>
