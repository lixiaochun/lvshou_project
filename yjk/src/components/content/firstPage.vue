  ...
  <div class="video-list">
     <div class="video-header">
       <list-table title="" :border="true" style="box-shadow:none">
         ...
         <div class="video-table">
            ...
            <el-table-column label="专题"  width="" prop="dissertationName" align="center"></el-table-column>
            ...
            <el-table-column label="浏览量（UV)" width="100" align="center">
                <template slot-scope="scope">
                  ...
                  <el-button type="text" @click="showForm(scope.$index, tableData, 'uv')">({{formatValue(tableData[scope.$index].inituv)}})</el-button>
                </template>
            </el-table-column>
     ...
     <div v-if="dialogFormVisible">
      <el-dialog  :visible.sync="dialogFormVisible" width="920px" :title="name">
         <div class="changeMount" v-if="name==='修改浏览量'" style="text-align:center">
          <span>添加浏览量:</span>
          <!-- <el-input placeholder="请输入添加的浏览量数值" v-model="num" size="mini" style="width:80%" type="number" maxlength="10"></el-input> -->
...
export default {
  ...
  methods: {
    ...
    _getVideoList(e) {
      ...
      this.loading = true
      getList({ id: tid, title, pageNum, pageSize, columnid, startTime, endTime, isShow: 1, type: 1, isIndexpage: 1 }).then(res => {
        if (res.code === ERR_SUCCESS) {
