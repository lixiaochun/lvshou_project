...
export default {
  data() {
    ...
    return {
      ...
      topicId: null,
      footerImage: require('../../assets/images/WomenDay/img_09.png'),
      // suspensionImg: {
      ...
      // },
      imgLists: [
        { src: require('../../assets/images/WomenDay/img_01.jpg'), imgSty },
        { src: require('../../assets/images/WomenDay/img_02.jpg'), imgSty },
        { src: require('../../assets/images/WomenDay/img_03.jpg'), imgSty },
        { src: require('../../assets/images/WomenDay/img_04.jpg'), imgSty },
        { src: require('../../assets/images/WomenDay/img_05.jpg'), imgSty },
        { src: require('../../assets/images/WomenDay/img_06.jpg'), imgSty },
        { src: require('../../assets/images/WomenDay/img_07.jpg'), imgSty }
      ]
    }
  },
  created() {
  ...
  mounted () {
    _hmt.push(['_trackEvent', '按钮', '女人节的许愿池', '页面初始化'])
  },
  methods: {
    async getBaseInfo() {
      // 通过接口获取基础信息
    ...
    verification() {
      ...
      if (!isApp() || this.is_web) {
        /* 下载APP */
        _hmt.push(['_trackEvent', '按钮', '女人节的许愿池', '下载APP'])
        window.location.href = 'http://app.hxsapp.com/html/channel_statistics.html?channel_id=582'
        return false;
      }
    ...
    suspension() {
      _hmt.push(['_trackEvent', '按钮', '女人节的许愿池', '咨询顾问'])
      var _this = this;
      /* 判断是否APP操作 */
    ...
    async hxsapp_jump_dynamic() {
      await _hmt.push(['_trackEvent', '按钮', '女人节的许愿池', '马上参与'])
      /* 判断是否APP操作 || 没有话题ID */
      if (!this.verification()) {
        return false;
      }
