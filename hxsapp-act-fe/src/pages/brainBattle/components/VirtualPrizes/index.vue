<template>
  <div class="NumberOfGames">
    <div v-bind:class="{contentBox: true,openBox: openBox,closebox: closebox}">
      ...
      <div class="closeImageBox" @click="VirtualPrizesBoxClose">
      ...
      <div class="content">
         <div class="textContent">
           ...
           <div class="looking">
             <img :src="looking" alt="立即查看" @click="look" />
           </div>
         </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      looking: require('../../assets/images/img_35.png'),
      gift: {},
      openBox: true,
      closebox: false
    }
  ...
  mounted() {
    ...
    visibilitychange.call(this, function (state) {
      if (this.visibilityState === 'hidden' && state === 'visible') {
        this.$parent.VirtualPrizesShow = false
      }
      this.visibilityState = state;
    }.bind(this))
  },
  methods: {
    VirtualPrizesBoxClose() {
