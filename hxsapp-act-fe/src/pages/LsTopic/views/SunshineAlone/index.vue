...
export default {
  data() {
    ...
    return {
      ...
      topicId: null,
      footerImage: require('../../assets/images/SunshineAlone/img_08.jpg'),
      suspensionImg: {
      ...
      imgLists: [
        { src: require('../../assets/images/SunshineAlone/img_01.jpg'), imgSty },
        { src: require('../../assets/images/SunshineAlone/img_02.jpg'), imgSty },
        { src: require('../../assets/images/SunshineAlone/img_03.jpg'), imgSty },
        { src: require('../../assets/images/SunshineAlone/img_04.jpg'), imgSty },
        { src: require('../../assets/images/SunshineAlone/img_05.jpg'), imgSty },
        { src: require('../../assets/images/SunshineAlone/img_06.jpg'), imgSty, click: 'imagesClick' },
        { src: require('../../assets/images/SunshineAlone/img_07.jpg'), imgSty }
      ]
    }
  },
  created() {
    ...
    _hmt.push(['_trackEvent', '按钮', '晒单有礼', '页面初始化'])
  ...
  methods: {
    ...
    verification() {
      ...
      if (!isApp() || this.is_web) {
        /* 下载APP */
        _hmt.push(['_trackEvent', '按钮', '晒单有礼', '下载APP'])
        window.location.href = 'http://app.hxsapp.com/html/channel_statistics.html?channel_id=579'
        return false;
      }
    ...
    suspension() {
      _hmt.push(['_trackEvent', '按钮', '晒单有礼', '减肥咨询'])
      var _this = this;
      /* 判断是否APP操作 */
    ...
    async hxsapp_jump_dynamic() {
      await _hmt.push(['_trackEvent', '按钮', '晒单有礼', '马上参与'])
      /* 判断是否APP操作 || 没有话题ID */
      if (!this.verification()) {
        return false;
      }
