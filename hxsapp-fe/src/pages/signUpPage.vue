<template>
		<div id="signUpPage">
			...
			<div v-show="isPreLoading && !signUpProtocol">
				...
				<div class="input_box">
					<input type="password" placeholder="请输入密码（6-20个字符）" v-model="password" />
				</div>
		...
		methods:{
			...
			readLoadPage( code ){
			  ...
			  var __inviteCode = commonJs.getUrlParam('inviteCode') ? commonJs.getUrlParam('inviteCode') : "" ;
				var __url  = commonJs.config.prefixUrl + "signUpPage?inviteCode=" + __inviteCode;
